...
/** Main functor implementing AVX2 gather and fold.
 *
 */
...
/** Function object which encapsulates the AVX2 gather and fold implementation.
 *
 * This function encapsulates the implementation of the AVX2 gather and fold for
 * dimension 1, 2, 3 in single and double precision.
 *
 */
extern const GatherFoldAvx2 gather_and_fold_avx2;
