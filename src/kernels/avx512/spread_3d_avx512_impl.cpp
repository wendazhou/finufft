...
template struct SpreadSubproblemPoly3DW8F64<4>;
template struct SpreadSubproblemPoly3DW8F64<5>;
template struct SpreadSubproblemPoly3DW8F64<6>;
template struct SpreadSubproblemPoly3DW8F64<7>;
template struct SpreadSubproblemPoly3DW8F64<8>;
template struct SpreadSubproblemPoly3DW8F64<9>;
template struct SpreadSubproblemPoly3DW8F64<10>;
template struct SpreadSubproblemPoly3DW8F64<11>;
...
get_subproblem_polynomial_avx512_3d_fp64_functor(kernel_specification const &kernel) {
    ...
    switch (it->degree) {
    case 4:
        return avx512::SpreadSubproblemPoly3DW8F64<4>(it->coefficients, it->width);
    case 5:
        return avx512::SpreadSubproblemPoly3DW8F64<5>(it->coefficients, it->width);
    case 6:
        return avx512::SpreadSubproblemPoly3DW8F64<6>(it->coefficients, it->width);
    case 7:
        return avx512::SpreadSubproblemPoly3DW8F64<7>(it->coefficients, it->width);
    case 8:
        return avx512::SpreadSubproblemPoly3DW8F64<8>(it->coefficients, it->width);
    case 9:
        return avx512::SpreadSubproblemPoly3DW8F64<9>(it->coefficients, it->width);
    case 10:
        return avx512::SpreadSubproblemPoly3DW8F64<10>(it->coefficients, it->width);
    case 11:
        return avx512::SpreadSubproblemPoly3DW8F64<11>(it->coefficients, it->width);
    default:
        throw std::runtime_error(
            "Precomputed polynomial kernel data for degree > 11 or degree < 4 not supported.");
    }
