...
Type1Plan<T, Dim> make_legacy_type1_plan(Type1TransformConfiguration<Dim> const &configuration) {
    auto kernel_spec = reference::get_default_kernel_specification(
    ...
    auto spread_functor =
        make_spread_functor<T, Dim>(kernel_spec, FoldRescaleRange::Pi, buffer_size);
...
#define INSTANTIATE(T, Dim)                                                                        \
    ...
    template Type1Plan<T, Dim> make_legacy_type1_plan(                                             \
